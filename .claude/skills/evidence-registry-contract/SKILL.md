...
- 发现 methodology 手工表与代码已经不同步 → 用 [diagnostic-commands](../diagnostic-commands/SKILL.md) 的规则表生成脚本重出全表修正，并回查是哪次合入漏过了 [acceptance-gates](../acceptance-gates/SKILL.md) 门禁 A 的同步项
